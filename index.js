...
function gameOutcome(playerInput) { 
    ...
    if (computerChoice == playerInput) {
        ...
        return document.getElementById("outcomeInfo").innerHTML = `Computer Chose ${computerChoice}! Computer Gets A Point!`,
            gameNumber ++,
            computerCounter ++,
            document.getElementById("computerCounter").innerHTML = `${computerCounter}`,
            document.getElementById("outcomeInfo").style.display = "flex";
    }
    else {
...
function finalDecision(){
    ...
    if (playerCounter == 5) {
        ...
        document.getElementById("computerCounter2").innerHTML = `${computerCounter}`, 
        document.getElementById("playerCounter2").innerHTML = `${playerCounter}`;
    }
    ...
    document.getElementById("introButton").onclick = function(){
        ...
        document.getElementById('playAgainButton').onclick = function(){
            ...
            document.getElementById("gameplaySection").style.display = "flex",
            document.getElementById("computerCounter").innerHTML = `0`, 
            document.getElementById("playerCounter").innerHTML = `0`,
            playerCounter = 0,
            computerCounter = 0;
        }
